...
namespace JobHunterApp.Controllers
{
    public class AccountTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccID,AccType")] AccountType accountType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccID,AccType")] AccountType accountType)
        {
            if (ModelState.IsValid)
            {
